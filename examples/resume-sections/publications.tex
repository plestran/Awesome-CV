...
%\cvpublication
%{10.} 
%{\textbf{P. J. Lestrange}, D. B. Williams-Young, C. A. Jim\'enez-Hoyos, X. Li, ``An Efficient Implementation of Variation After Projection Generalized Hartree-Fock." \textit{In preparation}.} 

%------------------------------------------------

\cvpublication
{9.} 
{J. J. Goings, \textbf{P. J. Lestrange}, X. Li, ``Real-Time Time-dependent Electronic Structure Theory." \textit{Submitted}.} 
